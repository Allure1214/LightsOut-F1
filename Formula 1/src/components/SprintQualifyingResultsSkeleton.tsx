...
export function SprintQualifyingResultsSkeleton() {
  return (
    <div className="space-y-8 sprint-qualifying-results-skeleton">
      {/* Header Skeleton */}
      <div className="space-y-6">
        ...
        {/* Sprint Qualifying Info Cards Skeleton */}
      ...
      {/* Sprint Qualifying Results Table Skeleton */}
      <Card>
        <CardHeader>
        ...
        <CardContent>
          {/* Sprint Qualifying Format Info Skeleton */}
